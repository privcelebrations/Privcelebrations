...
export default function TheatreCard({ theatre }: TheatreCardProps) {
  ...
  // CRITICAL FIX: Safe access to additionalImages
    ...
    <>
      <div className="bg-theatre-charcoal rounded-3xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300 shadow-2xl">
        ...
        >
          ...
          {/* SAFE USAGE: additionalImages instead of theatre.additionalImages */}
      ...
      <TheatreGalleryModal
        ...
        theatre={{
          ...theatre,
          additionalImages: additionalImages // PASS THE SAFE ARRAY
        }}
      />
    </>
  );
